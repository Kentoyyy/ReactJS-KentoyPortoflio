      ...
      <div className="skillsContainer">
        <div className="myskills">
          ...
          <div className='myskillText'>
            <h2>WEBSITES</h2>
            <p>Lorem ipsum dolor sit amet. Et autem praesentium qui magnam ducimus vel sequi reprehenderit. Aut sint quos qui provident quis eos pariatur ipsam ea fuga sequi. Et cumque sequi sit error repudiandae aut suscipit</p>
          </div>
        </div>
        <div className="myskills">
