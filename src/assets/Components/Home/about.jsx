  ...
  return (
    <section className="about" id="Aboutme">
      <div className='aboutContainer'>
        ...
        <p className="aboutDesc">
        I began my programming journey during my Senior High School years at<span className="highlight">STI College - Lipa</span> taking <span className="highlight">Information, Communication and Technology strand</span>. I was taught Web Development (HTML, CSS, JavaScript) and Native Mobile App Development (Java - Android Studio). 
        </p>
      </div>
    </section>  
  );
